...
public class WaveSurfingMovement_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "assignment6.framework.movement.WaveSurfingMovement"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(WaveSurfingMovement_ESTest_scaffolding.class.getClassLoader() ,
      "robocode.Robot",
      ...
      "assignment6.framework.movement.WaveSurfingMovement",
      ...
      "assignment6.framework.movement.WaveSurfingMovement$EnemyWave",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("robocode.robotinterfaces.peer.IBasicRobotPeer", false, WaveSurfingMovement_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(WaveSurfingMovement_ESTest_scaffolding.class.getClassLoader()); 
