...
public class StopAndGoMovement_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "assignment6.framework.movement.StopAndGoMovement"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StopAndGoMovement_ESTest_scaffolding.class.getClassLoader() ,
      "robocode.Robot",
      ...
      "assignment6.framework.movement.StopAndGoMovement",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("robocode.robotinterfaces.peer.IBasicRobotPeer", false, StopAndGoMovement_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StopAndGoMovement_ESTest_scaffolding.class.getClassLoader()); 
